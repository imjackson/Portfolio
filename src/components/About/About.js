        ...
        <div id="About" ref={ref} className={styles.AboutContainer}>
            ...
            <div className={styles.AboutMain}>
                <div className={styles.AboutLeft}>
                    <Paragraph>
                        I'm a freelance front-end developer currently working
                        out of Monmouth County, New Jersey. I seek to design and
                        develop user experiences that all can enjoy, with the
                        most efficient toolsets possible.
                    </Paragraph>
                    <Paragraph>
                        I'm an avid supporter of the Jamstack model to develop
                        fast and secure websites, taking advantage of CDNs to
                        serve static content, Git backends, and atomic deploys.
                    </Paragraph>
                    <Paragraph>
                        ...
                        designer/developer. I design and create front-end
                        components while providing recommendations for
                        maintaining proper usability and accessibility
                        throughout their multi-platform messaging app.
                    </Paragraph>
