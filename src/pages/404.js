...
const NotFoundPage = () => (
    <div className={s.PageContainer}>
        ...
        <div className={s.NotFoundContent}>
            ...
            <h1 className={s.NotFoundNumber}>
                {" "}
                <span className={s.NotFoundNumberSmall}>a</span> 404{" "}
                <span className={s.NotFoundNumberSmall}>error.</span>
            </h1>
            <p className={s.NotFoundText}>
                It seems you've been led to a route that doesn't exist on my
                site. That's especially weird considering my site is only one
                page. No worries, just click the link below to view my site.
            </p>
